...
APIKEY = 'dKn2KDHmCWyBcV5jZ3=wL0TKqiw='  # 改成你的APIKEY

apiurl = 'http://api.heclouds.com/devices/570031670/datapoints' #链接里面的数字要改成自己的
...
def http_put():
    ...
    payload = {'datastreams': [{"id": "temp", "datapoints": [{"at": CurTime.isoformat(), "value": temperature}]}]}
